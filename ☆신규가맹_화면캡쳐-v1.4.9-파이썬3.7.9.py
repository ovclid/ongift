...
def start_webdriver():
    ...
    #prefs = {'download.default_directory' : './webDownload'}
...
def images_to_file (i, images, store_name, current_folder):
    ...
    except ValueError as e:  # ValueError: cannot save mode RGBA
        background = Image.new("RGB", downfile_image.size, (255, 255, 255))
        background.paste(downfile_image, mask=downfile_image.split()[3])
        images_result[-1] = background
